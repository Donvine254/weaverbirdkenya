        ...
        >
            <div className="relative z-10 mx-auto max-w-7xl px-6 grid-cols-1 items-center grid gap-16 md:grid-cols-2">
                ...
                <div>
                    ...
                    <p
                        className="mb-6"
                        style={{ color: "rgba(251, 248, 240, 0.85)" }}
                    >
                        Our Maasai shukas celebrate tradition with vibrant colours,
                        authentic patterns and superior quality — perfect for cultural
                        events, tourism, corporate gifts and everyday style. Made with
                        premium cotton fabrics for comfort, durability and vibrant colour
                        retention.
                    </p>
